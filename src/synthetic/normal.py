...
from src.utils.synthetic_utils import normal_proposal_sample as proposal_sample
from src.utils.synthetic_utils import normal_IS_ratio as ratio_IS
...
if is_notebook():
    ...
    parser.add_argument(
        "--seed", "-s", default=5345, type=int, help="Seed value to use.",
    )
    parser.add_argument(
        "--params_min",
        "-min",
